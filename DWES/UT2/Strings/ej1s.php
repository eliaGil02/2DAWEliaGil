<!--
Objetivo: Convertir la IP a su representación en binario haciendo uso de la función printfo sprintf.
...
<body>
    ...
    printf("IP %s en binario es %s.%s.%s.%s", $ip, $bin1, $bin2, $bin3, $bin4);
    ?>
</body>
